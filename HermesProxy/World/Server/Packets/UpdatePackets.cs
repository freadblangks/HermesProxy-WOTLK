        ...
        public override void Write()
        {
            ...
            foreach (var update in ObjectUpdates)
            {
                ...
                switch (ModernVersion.GetUpdateFieldsDefiningBuild())
                {
                    ...
                    case ClientVersionBuild.V3_4_3_54621:
                    {
                        Objects.Version.V3_4_3_54621.ObjectUpdateBuilder builder = new Objects.Version.V3_4_3_54621.ObjectUpdateBuilder(update, _gameState);
                        builder.WriteToPacket(data);
                        break;
                    }
                    default:
